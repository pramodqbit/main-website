...
export default function ContactUs() {
	...
	return (
		<div className='w-full min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 py-10 md:py-20 px-4 md:px-8'>
			<div className='max-w-7xl mx-auto'>
						...
						<form onSubmit={handleSubmit} className='space-y-6'>
							<div>
								<input
									...
									className='w-full pb-3 border-b-2 border-gray-300 focus:border-primary outline-none text-gray-700 placeholder-gray-400 transition-colors'
									required
								/>
							</div>
							<div>
							...
							<div>
								<textarea
									...
									onChange={handleChange}
									rows={4}
									className='w-full pb-3 border-b-2 border-gray-300 focus:border-primary outline-none text-gray-700 placeholder-gray-400 transition-colors resize-none'
									required
								/>
							</div>
							<Button
					...
					<div className='space-y-8'>
						...
						<div className='flex flex-wrap gap-8'>
							...
							<div>
								...
								<p className='text-gray-700'>info@nexus.com</p>
							</div>
						</div>
				...
				<div className='hidden lg:grid lg:grid-cols-2 lg:gap-12 xl:gap-20 items-center'>
					...
					<div className='space-y-10'>
						<div>
							<h1 className='text-xl xl:text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-6'>
								We&apos;re Here To Connect And Assist You
							</h1>
						...
						<div className='space-y-6'>
							<div>
								...
								<p className='text-gray-700 text-lg'>+31 20 123 4567</p>
							</div>
							...
							<div>
								...
								<p className='text-gray-700 text-lg'>info@nexus.com</p>
							</div>
						</div>
					...
					<div className='bg-white rounded-3xl p-8 xl:p-12 shadow-2xl'>
						...
						<form onSubmit={handleSubmit} className='space-y-8'>
							...
							<Button
								type='submit'
								className='bg-black hover:bg-gray-800 text-white px-10 py-3 rounded-lg transition-colors text-lg'>
								Contact Us
							</Button>
						</form>
					</div>
